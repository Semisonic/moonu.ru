...
var compile = function(fileName, assets, S3, options, method, type, timestamp, callback) {
  ...
  return function(err, results) {
    ...
    switch(method) {
      case 'uglify':
        var toplevel = UglifyJS.parse(results);
...
var CDN = function(app, options, callback) {
  ...
  if ((typeof options.production === 'undefined')&&(process.env.NODE_ENV=='production')){
    options.production = true;
  } else if ((typeof options.production === 'undefined')&&(process.env.NODE_ENV=='development')){
